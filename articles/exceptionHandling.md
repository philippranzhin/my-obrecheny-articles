...
### Способов борбы с исключениями несколько, не очень ппонятно, когда и какой использовать.
